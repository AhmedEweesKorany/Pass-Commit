...
export default function MasterPasswordScreen({ isSetup, onSuccess }: MasterPasswordScreenProps) {
    ...
    return (
        <div className="flex flex-col items-center justify-center h-full min-h-[400px] p-6 animate-fade-in">
            {/* Icon */}
            <div className="mb-6">
                <div className="w-16 h-16 rounded-xl bg-gradient-to-br from-primary-500/20 to-primary-700/20 border border-primary-500/30 flex items-center justify-center">
                    {isSetup ? (
